...
<body>
    ...
    <section class="body-main" style="margin-top: 58px">
        ...
        <div class="container-fluid">
            <!--------release-->
            <div class="box-release-geral">
                <div class="title-release">
                    <h1>Lançamentos</h1>
                </div>
                <div class="hr"></div>
                <div class="box-release">
                    <div class="box-artist1-music-photo" style="background-image:url('img/photo-music/');">
                    ...
                    <div class="box-release-text">
                        <h1>Nevermind</h1>
                        <p>Nirvana, 10 out 1992</p>
                    </div>
                </div>
                <div class="hr"></div>
            </div>
