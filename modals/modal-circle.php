        ...
        <div class="col-md-3 col-modal-3">
                ...
                ?>
                    ...
                    <div class="box-single-modal">
                        <!--geral controlador -->
                        <div class="box-single-photo-modal circle-modal" style="background-image:url('img/photo-music/<?php echo $List['img'] ?>');">
                            <div class="box-single-photo-content" style="border-radius: 50%;">
                                <!--conteudo hover-->
