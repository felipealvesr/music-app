    ...
    <header>
        ...
        <div id="sidenav-1" class="sidenav bg-sidenav width-sidenav" role="navigation" data-hidden="false" data-accordion="true">
            ...
            <ul class="sidenav-menu">
                ...
                <li class="sidenav-item">
                    <!--item 4-->
                    <a class="sidenav-link link-active ripple" href="artist.php">
    ...
    <section class="body-main">
        ...
        <section class="container-fluid ">
                ...
                ?>
                    ...
                    <div class="box-artist">
                        ...
                        <div class="box-artist-text" style="margin-top: 10px;">
                            <a href="artist.php">
                                <h1><?php echo $CarArtistList['artist'] ?></h1>
                            </a>
                        </div>
                    </div>
                    <!--fm item 1-->
            ...
            <div class="container-fluid">
                ...
                <!---------------------section hot singles------------------------->
                <section class="container-fluid container-margin">
                    <div class="row">
                        <div class="col-md-6">
                            <!--text-->
                            <div class="text-single">
